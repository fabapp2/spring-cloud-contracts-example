...
----
            <plugin>
                ...
                <configuration>
                    ...
                    <contractsRepositoryUrl>http://localhost:8081/artifactory/libs-release</contractsRepositoryUrl> <1>
...
.. login to your local http://localhost:8000[artifactory] using username `admin` with password `password` as credentials.
